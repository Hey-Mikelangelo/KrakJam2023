...
public static class Vector4Extensions
{
    ...
    {
        return new Vector4(vector.x.Map(min1, max1, min2, max2), vector.y.Map(min1, max1, min2, max2), vector.z.Map(min1, max1, min2, max2), vector.w.Map(min1, max1, min2, max2));
    }
